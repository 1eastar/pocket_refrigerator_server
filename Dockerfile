...
RUN         echo "from django.contrib.auth.models import User; User.objects.filter(username='happyhappy1').delete(); User.objects.create_superuser('happyhappy1', 'ehdwls6703@gmail.com', 'happyhappy1')" | python manage.py shell
WORKDIR     ${PROJECT_DIR}
